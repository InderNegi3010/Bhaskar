...
export default function AchievementsSection() {
  const certifications = [
    {
      icon: GraduationCap,
      title: "Post-Graduate in Yogic Science",
      institution: "kumaun University",
      description:
        "Advanced studies in yoga philosophy, anatomy, and teaching methodology",
    },
    {
      icon: Award,
      ...
      description:
        "International certification for teaching Hatha and Vinyasa yoga",
    },
    {
      icon: BookOpen,
      ...
      description:
        "Specialized training in breath control and meditation practices",
    },
  ];

  const achievements = [
    { number: "1000+", label: "Students Taught", icon: Star },
    { number: "3+", label: "Years Experience", icon: Medal },
        ...
        >
          {achievements.map((item, index) => (
            ...
            >
              ...
              <p className="text-2xl sm:text-3xl md:text-4xl font-light text-[#606c38] mb-1">
                {item.number}
              </p>
          ...
          {certifications.map((cert, index) => (
            ...
            >
              <div className="h-full p-6 sm:p-8 rounded-2xl border border-[#e8e4dc] bg-white hover:border-[#606c38]/30 hover:shadow-xl transition-all duration-300">
                ...
                {/* Content */}
                <h3 className="text-lg sm:text-xl font-medium text-[#3d405b] mb-2">
                  {cert.title}
                </h3>
                <p className="text-xs sm:text-sm text-[#dda15e] mb-2 sm:mb-3">
                  {cert.institution}
                </p>
