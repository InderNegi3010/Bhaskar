...
export default function ServicesSection() {
  const services = [
    {
      ...
      description:
        "Experience the convenience of professional yoga instruction in the comfort of your own home. Perfect for those who prefer privacy, have busy schedules, or simply want undivided attention.",
      features: [
    ...
    },
    {
      ...
      description:
        "Join our welcoming yoga center for group classes that harness the power of collective energy. Benefit from a dedicated space designed for optimal practice and connect with fellow yoga enthusiasts.",
      features: [
  ...
  return (
    <section
      id="services"
      className="py-16 sm:py-20 md:py-24 lg:py-32 bg-[#f5f1eb]"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-sm sm:text-base text-[#5c5c5c] px-4">
            Choose the practice setting that resonates with your lifestyle and
            preferences. Both options deliver the same quality of instruction
        ...
        <div className="space-y-12 sm:space-y-16 md:space-y-20 lg:space-y-24">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Content */}
              <div
                className={`pt-6 sm:pt-8 lg:pt-0 ${index % 2 === 1 ? "lg:order-1" : ""}`}
              >
                <h3 className="text-2xl sm:text-3xl font-light text-[#3d405b] mb-3 sm:mb-4">
                  {service.title}
                </h3>
                <p className="text-sm sm:text-base text-[#5c5c5c] leading-relaxed mb-6 sm:mb-8">
                  {service.description}
                </p>
