      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col items-center gap-6 sm:gap-8">
          ...
          <div className="flex items-center gap-2">
            <span className="text-2xl sm:text-3xl text-[#dda15e]">ॐ</span>
            <span className="font-light text-lg sm:text-xl">Bhaskar Singh Yoga</span>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <a 
              ...
              className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/10 hover:bg-[#dda15e] flex items-center justify-center transition-all duration-300 hover:scale-110"
          ...
          {/* Copyright */}
          <div className="border-t border-white/10 pt-4 sm:pt-6 w-full text-center">
            <p className="text-xs sm:text-sm text-white/50 flex items-center justify-center gap-1">
              Made with <Heart className="w-3 h-3 sm:w-4 sm:h-4 text-[#dda15e]" /> for wellness
            </p>
