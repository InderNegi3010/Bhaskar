...
export default function ContactSection() {
  ...
  const contactInfo = [
    {
      ...
      label: "Phone",
      value: "+91 9389652307",
      href: "tel:+919389652307",
    },
    {
      icon: Mail,
      label: "Email",
      value: "yogibhaskar0777@gmail.com",
      href: "mailto:yogibhaskar0777@gmail.com",
    },
    {
      icon: Clock,
      label: "Available",
  ...
  return (
    <section
      id="contact"
      className="py-16 sm:py-20 md:py-24 lg:py-32 bg-gradient-to-br from-[#f5f1eb] to-white"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="max-w-xl mx-auto text-sm sm:text-base text-[#5c5c5c] px-4">
            Ready to transform your life through yoga? Reach out to book a
            session or learn more about my offerings.
          </p>
        </Motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            <div className="bg-[#3d405b] rounded-2xl p-6 sm:p-8 text-white">
              <h3 className="text-lg sm:text-xl font-light mb-4 sm:mb-6">
                Get in Touch
              </h3>
                ...
                {contactInfo.map((item) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <p className="text-white/60 text-xs sm:text-sm mb-0.5">
                        {item.label}
                      </p>
                      {item.href ? (
                        <a
                          href={item.href}
                          className="hover:text-[#dda15e] transition-colors text-sm sm:text-base break-words"
                        >
                          {item.value}
                        </a>
                      ) : (
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-10 shadow-xl border border-[#e8e4dc]">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <h4 className="text-lg sm:text-xl text-[#3d405b] mb-2">
                    Thank You!
                  </h4>
                ...
                >
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
                    <div>
                      <label className="text-xs sm:text-sm text-[#5c5c5c] mb-2 block">
                        Full Name
                      </label>
                      <Input
                        value={formData.name}
                  ...
                  <p className="text-[10px] sm:text-xs text-center text-[#8b8b8b]">
                    By submitting, you agree to be contacted regarding yoga
                    sessions.
                  </p>
                </form>
              )}
